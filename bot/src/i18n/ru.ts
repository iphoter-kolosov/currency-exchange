...
export const ru: Dict = {
  start: {
    greeting:
      `Привет, {name}! 👋\n\nЯ твой личный консультант по валютам и финансам — живу в этой экосистеме 24/7: курсы в реальном времени, графики, алерты, ежедневные сводки. Знаю, куда движется рынок, и говорю на твоём языке 🤝\n\nСо мной можно <b>как с человеком</b> — просто пиши:\n• <code>100 usd eur</code> — мгновенная конвертация\n• <code>eur</code> — все курсы к евро\n• <code>график евро к доллару за год</code>\n• <code>каждый день в 9 утра евро к гривне</code>\n\nА можно <b>кнопками</b> — всё собрано в меню ниже ⤵️\n\n<i>Проект от BigRate.app</i>`,
