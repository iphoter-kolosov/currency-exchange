...
export const ar: Dict = {
  start: {
    greeting:
      `مرحبًا {name} 👋\n\nأنا مساعدك للعملات: أسعار لحظية، ورسوم بيانية، وتنبيهات، وملخصات يومية.\n\n<b>فقط اكتب — سأفهم</b>\n• <code>100 usd eur</code> — تحويل\n• <code>eur</code> — جميع أسعارك مقابل اليورو\n• <code>رسم بياني يورو إلى دولار لسنة</code>\n• <code>كل يوم الساعة 9 صباحًا يورو إلى دولار</code>\n\nأو اضغط زرًا بالأسفل 👇`,
    menu_convert: '💱 تحويل',
    menu_watch: '👁 القائمة',
